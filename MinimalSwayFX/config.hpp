 ...
 * */
const std::string msfx_font_style = "regular";
 ...
 *                     <path_to_wallpaper>]
 * */
const std::string msfx_wallpaper = "~/Pictures/gowall/pexels-creative-vix-9754.jpg";
 ...
 * Available options: [none, low, medium, high]
 * */
const msfx_level msfx_corner_radius = none;
